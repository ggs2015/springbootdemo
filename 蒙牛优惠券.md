...
|»» effectEndTime|body|string| 否 |none|
...
|» baseInfo|body|[CouponTemplateBaseInfoVO11](#schemacoupontemplatebaseinfovo11)| 是 |券模板基础信息|
...
|» reduceRule|body|[CouponTemplateReduceRuleVO10](#schemacoupontemplatereducerulevo10)| 是 |券模板优惠规则|
...
|» sendRule|body|[CouponTemplateSendRuleVO9](#schemacoupontemplatesendrulevo9)| 是 |券模板发放规则|
...
|» useRule|body|[CouponTemplateUseRuleVO7](#schemacoupontemplateuserulevo7)| 是 |券模板使用规则|
|»» useValidDate|body|[UseValidDate8](#schemausevaliddate8)| 是 |券使用有效期|
...
|»»» weekDay|body|[integer]| 否 |工作日|
|»»» timeSegment|body|[[TimeSegmentDTO](#schematimesegmentdto)]| 否 |时间段|
|»»»» beginHour|body|integer| 否 |none|
|»»»» endHour|body|integer| 否 |none|
|»»»» beginMinute|body|integer| 否 |none|
|»»»» endMinute|body|integer| 否 |none|
...
**»» createChannel**: 创建渠道
1:B端后台,2:openapi,3:旺铺迁移,4:直播APP,5:异业平台-计划申领

**»» requestChannel**: 请求渠道
目前用于业务方告知请求渠道信息，发送OpenAPI消息
...
|» reduceRule|body|[CouponTemplateReduceRuleVO10](#schemacoupontemplatereducerulevo10)| 否 |券模板优惠规则|
|»» reducePriceType|body|integer| 否 |减免的类型|
|»» cashTicketAmt|body|number| 否 |代金券减免金额，支持小数点后 2位小数|
|»» maxReducePrice|body|number| 否 |最大减免金额(每满减券才有)，支持小数点后 2位小数|
|»» discount|body|number| 否 |折扣券减免折扣，支持小数点后 2位小数|
...
|»» importGoodsFlag|body|boolean| 否 |是否是导入商品；不支持|
|»» importGoodsFileName|body|string| 否 |导入文件名；不支持|
|» otherSetting|body|[CouponTemplateOtherSettingVO12](#schemacoupontemplateothersettingvo12)| 否 |模板其他设置|
...
|»» useValidDate|body|[UseValidDate8](#schemausevaliddate8)| 否 |券使用有效期|
|»»» useTimeType|body|integer| 否 |时间类型，1：固定，2：动态，3：周期|
|»»» subUseTimeType|body|integer| 否 |可用时间子类型；/**|
|»»» useStartTime|body|string| 否 |使用开始时间，单位时间戳(精确毫秒)|
|»»» useEndTime|body|string| 否 |使用结束时间，单位时间戳(精确毫秒)|
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|skuId|integer|false|none||sku 的 id|
|goodsId|integer|false|none||商品 id|
|vid|integer|false|none||节点 id|
|itemTitle|string|false|none||名称|
|specValueInfo|string|false|none||sku信息|
|salePrice|number|false|none||销售价，支持2 位小数|
|productId|integer|false|none||适用对象所属的产品id|
|channel|integer|false|none||参与对象所属的渠道，扩展字段|
|channelName|string|false|none||渠道名称，扩展字段|
|defaultImageUrl|string|false|none||默认图片|
...
|effectStartTime|string|false|none||yyyy-MM-dd HH:mm:ss|
|effectEndTime|string|false|none||none|
...
```json
{
  ...
  "goodsProductSource": 0,
  "goodsChannelSourceId": 0
}
...
|tags|[string]|false|none||商品tag集合，与用户的tags类似，我们不感知具体业务含义，仅用来做规则筛选与校验等内容|
|tagIds|[integer]|false|none||标签id|
|groupIds|[integer]|false|none||分组id集合|
|isStoreGoods|boolean|false|none||是否是门店自建商品|
|belongVid|[VidTypeInfo](#schemavidtypeinfo)|false|none||商品归属vid信息|
|goodsProductSource|integer|false|none||适用对象所属的产品id|
|goodsChannelSourceId|integer|false|none||资料库资源id|
...
|selected|boolean|false|none||是否选中|

<h2 id="tocS_VidCodeInfo">VidCodeInfo</h2>

<a id="schemavidcodeinfo"></a>
<a id="schema_VidCodeInfo"></a>
<a id="tocSvidcodeinfo"></a>
<a id="tocsvidcodeinfo"></a>
...
|---|---|---|---|---|---|
|merchantId|integer|false|none||none|
|bosId|integer|true|none||none|
|vid|integer|true|none||none|
|vidName|string|false|none||none|
|vidType|integer|false|none||none|
|vidCode|string|false|none||vid优先|
...
|---|---|---|---|---|---|
|basicInfo|[BasicInfo](#schemabasicinfo)|false|none||创建券的basicInfo信息<br />查的时候有些需要通过创建的basicInfo信息查<br />比如区域的分组，在品牌需要通过区域的vid才能查到|
|produceId|integer|false|none||产品实例id；扩展字段|
|bosId|integer|false|none||商家id|
|belongVid|integer|false|none||券归属的vid|
|belongVidType|integer|false|none||归属节点类型|
...
|excludeSkuInfos|[[SkuInfo](#schemaskuinfo)]|false|none||建券支持sku级别（排除）|
|excludeSkuIdInfos|[[SkuInfo](#schemaskuinfo)]|false|none||排除sku<br />优先级高于excludeSkuInfos，若id未传入则用优先级高于excludeSkuInfos|
|goodsNum|integer|false|none||如果acceptStoreType是5或者6，商品数量|
|skuNum|integer|false|none||如果acceptStoreType是5或者6，sku 数量|
|productIds|[integer]|false|none||参与对象有些productId|
|categoryObjectList|[[CategoryObjectVO](#schemacategoryobjectvo)]|false|none||适用类目对象|
|classifyObjectList|[[ClassifyObjectVO](#schemaclassifyobjectvo)]|false|none||适用分组对象|
|goodsTagList|[[GoodsTagVO](#schemagoodstagvo)]|false|none||适用商品标签信息|
|acceptGoodsList|[[GoodsVO](#schemagoodsvo)]|false|none||适用商品信息|
|excludeGoodsList|[[GoodsVO](#schemagoodsvo)]|false|none||排除商品信息列表|
|storeInfoList|[[StoreInfoDTO](#schemastoreinfodto)]|false|none||门店信息列表|
|excludeStoreInfoList|[[StoreInfoDTO](#schemastoreinfodto)]|false|none||排除的门店信息列表|
|vidInfoList|[[AcceptVidInfo](#schemaacceptvidinfo)]|false|none||新组件，只是用b端前端传值和回显|
|categoryObjectListMap|[MapListCategoryObjectVO](#schemamaplistcategoryobjectvo)|false|none||适用类目对象<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|classifyObjectListMap|[MapListClassifyObjectVO](#schemamaplistclassifyobjectvo)|false|none||适用分组对象<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|acceptGoodsListMap|[MapListGoodsVO](#schemamaplistgoodsvo)|false|none||适用商品信息<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|excludeGoodsListMap|[MapListGoodsVO](#schemamaplistgoodsvo)|false|none||适用商品信息<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|acceptGoodGroupsMap|[MapListGoodGroup](#schemamaplistgoodgroup)|false|none||建券时，商品分组<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|skuInfosMap|[MapListSkuInfo](#schemamaplistskuinfo)|false|none||建券支持sku级别<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|excludeSkuInfosMap|[MapListSkuInfo](#schemamaplistskuinfo)|false|none||建券支持sku级别<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|acceptGoodsIdsMap|[MapListLong](#schemamaplistlong)|false|none||适用商品列表<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
|excludeGoodsIdsMap|[MapListLong](#schemamaplistlong)|false|none||适用商品列表<br />巴拉二期废弃 替换为acceptInfoVO<br />「已废弃」|
...
<h2 id="tocS_MapListSkuInfo">MapListSkuInfo</h2>

<a id="schemamaplistskuinfo"></a>
<a id="schema_MapListSkuInfo"></a>
<a id="tocSmaplistskuinfo"></a>
<a id="tocsmaplistskuinfo"></a>
...
<h2 id="tocS_MapListGoodGroup">MapListGoodGroup</h2>

<a id="schemamaplistgoodgroup"></a>
<a id="schema_MapListGoodGroup"></a>
<a id="tocSmaplistgoodgroup"></a>
<a id="tocsmaplistgoodgroup"></a>
...
|classifyLevel|integer|false|none||当前分组等级|
|parentId|integer|false|none||父分组id|
|child|[[GoodGroup](#schemagoodgroup)]|false|none||二级分组|
|bizVid|integer|false|none||none|
|productId|integer|false|none||适用对象所属的产品id|
|channel|integer|false|none||参与对象所属的渠道|
|channelName|string|false|none||none|

<h2 id="tocS_MapListGoodsVO">MapListGoodsVO</h2>

<a id="schemamaplistgoodsvo"></a>
<a id="schema_MapListGoodsVO"></a>
<a id="tocSmaplistgoodsvo"></a>
<a id="tocsmaplistgoodsvo"></a>
...
|createVid|integer|false|none||创建vid|
|title|string|false|none||商品名|
|isMemberShipDiscount|number|false|none||商品是否参与会员折扣|
|minMemberShipPrice|number|false|none||商品会员价|
|minOriginalPrice|number|false|none||商品市场价|
|isCanSell|boolean|false|none||是否可售|
|isOnline|boolean|false|none||是否上架|
|goodsUrl|string|false|none||商品图片url|
|isDeleted|boolean|false|none||是否删除|
|maxCostPrice|number|false|none||商品最大成本价（所有SKU中的最大成本价）|
|minCostPrice|number|false|none||最小成本价（所有SKU中的最小成本价）|
|maxMarketPrice|number|false|none||最大市场价（所有SKU中的最大市场价）|
|minMarketPrice|number|false|none||最小市场价（所有SKU中的最大市场价）|
|maxSalePrice|number|false|none||最大销售价（所有SKU中的最大销售价）|
|minSalePrice|number|false|none||最小销售价（所有SKU中的最大销售价）|
|productId|integer|false|none||适用对象所属的产品id|
|channel|integer|false|none||参与对象所属的渠道|
|channelName|string|false|none||none|

<h2 id="tocS_MapListClassifyObjectVO">MapListClassifyObjectVO</h2>

<a id="schemamaplistclassifyobjectvo"></a>
<a id="schema_MapListClassifyObjectVO"></a>
<a id="tocSmaplistclassifyobjectvo"></a>
<a id="tocsmaplistclassifyobjectvo"></a>
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|classifyId|integer|false|none||分组id|
|parentId|integer|false|none||父节点id|
|name|string|false|none||分组名称|
|bizVid|integer|false|none||商圈需要的|
|productId|integer|false|none||适用对象所属的产品id|
|channel|integer|false|none||适用对象所属的渠道id|
|channelName|string|false|none||none|

<h2 id="tocS_MapListCategoryObjectVO">MapListCategoryObjectVO</h2>

<a id="schemamaplistcategoryobjectvo"></a>
<a id="schema_MapListCategoryObjectVO"></a>
<a id="tocSmaplistcategoryobjectvo"></a>
<a id="tocsmaplistcategoryobjectvo"></a>
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|categoryId|integer|false|none||适用对象id|
|categoryName|string|false|none||类目名称|
|productId|integer|false|none||适用对象所属的产品id|
|channel|integer|false|none||适用对象所属的渠道id|
|channelName|string|false|none||none|

<h2 id="tocS_AcceptVidInfo">AcceptVidInfo</h2>

<a id="schemaacceptvidinfo"></a>
<a id="schema_AcceptVidInfo"></a>
<a id="tocSacceptvidinfo"></a>
<a id="tocsacceptvidinfo"></a>
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|type|integer|false|none||节点类型，与 vid 相对应。类型包括：1-集团；2-品牌；3-区域；4部门；5-商场；6-楼层；10-门店；11-网点；100-自提点|
|value|[[ValueDTO](#schemavaluedto)]|false|none||none|
|typeName|string|false|none||类型名称|

<h2 id="tocS_ValueDTO">ValueDTO</h2>

<a id="schemavaluedto"></a>
<a id="schema_ValueDTO"></a>
<a id="tocSvaluedto"></a>
<a id="tocsvaluedto"></a>
...
|vid|integer|false|none||节点 id|
|vidName|string|false|none||节点名称|
|vidType|integer|false|none||节点类型：节点类型，与 vid 相对应。类型包括：1-集团；2-品牌；3-区域；4部门；5-商场；6-楼层；10-门店；11-网点；100-自提点|

<h2 id="tocS_StoreInfoDTO">StoreInfoDTO</h2>

<a id="schemastoreinfodto"></a>
<a id="schema_StoreInfoDTO"></a>
<a id="tocSstoreinfodto"></a>
<a id="tocsstoreinfodto"></a>
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|vid|integer|false|none||门店vid<br />已废弃用id字段<br />「已废弃」|
|vidType|integer|false|none||已废弃用type字段<br />「已废弃」|
|vidName|string|false|none||门店名称<br />已废弃用name字段<br />「已废弃」|
|id|integer|false|none||vid/标签id|
|type|integer|false|none||id对应的类型，若id为vid那type为vidType|
|name|string|false|none||节点/标签名称|

<h2 id="tocS_GoodsVO">GoodsVO</h2>

<a id="schemagoodsvo"></a>
<a id="schema_GoodsVO"></a>
<a id="tocSgoodsvo"></a>
<a id="tocsgoodsvo"></a>
...
<h2 id="tocS_GoodsTagVO">GoodsTagVO</h2>

<a id="schemagoodstagvo"></a>
<a id="schema_GoodsTagVO"></a>
<a id="tocSgoodstagvo"></a>
<a id="tocsgoodstagvo"></a>
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|goodsTagId|integer|false|none||商品标签id|
|goodsTagName|string|false|none||商品标签名称|
|productId|integer|false|none||适用对象所属的产品id|

<h2 id="tocS_ClassifyObjectVO">ClassifyObjectVO</h2>

<a id="schemaclassifyobjectvo"></a>
<a id="schema_ClassifyObjectVO"></a>
<a id="tocSclassifyobjectvo"></a>
<a id="tocsclassifyobjectvo"></a>
...
<h2 id="tocS_CategoryObjectVO">CategoryObjectVO</h2>

<a id="schemacategoryobjectvo"></a>
<a id="schema_CategoryObjectVO"></a>
<a id="tocScategoryobjectvo"></a>
<a id="tocscategoryobjectvo"></a>
...
<h2 id="tocS_CouponTemplateUseRuleVO7">CouponTemplateUseRuleVO7</h2>

<a id="schemacoupontemplateuserulevo7"></a>
<a id="schema_CouponTemplateUseRuleVO7"></a>
<a id="tocScoupontemplateuserulevo7"></a>
<a id="tocscoupontemplateuserulevo7"></a>
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|useValidDate|[UseValidDate8](#schemausevaliddate8)|true|none||券使用有效期|
|hasUseThreshold|boolean|false|none||是否使用有门槛|
|canCashTicket|boolean|false|none||是否开启满元门槛|
...
|isAllUseScene|boolean|false|none||是否是全部核销场景|
|allSceneDTO|[AllSceneDTO](#schemaallscenedto)|false|none||核销场景：商城、堂食、外卖、酒旅|
|usageDesType|integer|false|none||仅控制C端文案展示，不产生实际校验逻辑|
|isAllTimeUse|boolean|false|none||可用时段类型核销<br />是否是全部时段|
|cycleUseRule|[[UsableTimeRuleDTO](#schemausabletimeruledto)]|false|none||部分时段可核销|
|superpositionRule|[SuperpositionRuleDTO2](#schemasuperpositionruledto2)|false|none||叠加规则|
...
<h2 id="tocS_UseValidDate8">UseValidDate8</h2>

<a id="schemausevaliddate8"></a>
<a id="schema_UseValidDate8"></a>
<a id="tocSusevaliddate8"></a>
<a id="tocsusevaliddate8"></a>
...
<h2 id="tocS_CouponTemplateSendRuleVO9">CouponTemplateSendRuleVO9</h2>

<a id="schemacoupontemplatesendrulevo9"></a>
<a id="schema_CouponTemplateSendRuleVO9"></a>
<a id="tocScoupontemplatesendrulevo9"></a>
<a id="tocscoupontemplatesendrulevo9"></a>
...
|---|---|---|---|---|---|
|sendTimeType|integer|false|none||发放时间类型 (1无限制；2固定时间)|
|sendStartDate|string|false|none||发放开始时间，单位时间戳(精确毫秒)|
|sendEndDate|string|false|none||发放结束时间，单位时间戳(精确毫秒)|
...
<h2 id="tocS_CouponTemplateReduceRuleVO10">CouponTemplateReduceRuleVO10</h2>

<a id="schemacoupontemplatereducerulevo10"></a>
<a id="schema_CouponTemplateReduceRuleVO10"></a>
<a id="tocScoupontemplatereducerulevo10"></a>
<a id="tocscoupontemplatereducerulevo10"></a>
...
<h2 id="tocS_CouponTemplateBaseInfoVO11">CouponTemplateBaseInfoVO11</h2>

<a id="schemacoupontemplatebaseinfovo11"></a>
<a id="schema_CouponTemplateBaseInfoVO11"></a>
<a id="tocScoupontemplatebaseinfovo11"></a>
<a id="tocscoupontemplatebaseinfovo11"></a>
...
|basicCouponTemplateIdList|[integer]|false|none||券基础模板Id List，用于新建模板时的参数；创建模板时填|
...
<h2 id="tocS_CouponTemplateOtherSettingVO12">CouponTemplateOtherSettingVO12</h2>

<a id="schemacoupontemplateothersettingvo12"></a>
<a id="schema_CouponTemplateOtherSettingVO12"></a>
<a id="tocScoupontemplateothersettingvo12"></a>
<a id="tocscoupontemplateothersettingvo12"></a>
